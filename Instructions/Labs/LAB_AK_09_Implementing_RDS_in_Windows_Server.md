...
1. On the **This site is not secure** page, select **Details**,<!-- Should they review the details? --> and then select **Go on to the webpage**.
...
1. On the **Select RemoteApp programs** page, scroll down<!-- "scroll" is a non-accessibility word. Could we change this to, "On the ... page, under ..., search for and select WordPad, and then select Next"? --> in the list under **The RemoteApp programs are populated from SEA-RDS1.CONTOSO.COM**. Select **WordPad** and select **Next**.
...
2. On the **This site is not secure page**, select **Details**,<!-- Should they review them? Otherwise, why are they selecting Details? --> and then select **Go on to the webpage**.
...
7. In the **Startup type** box<!-- What type of box is this? Dialog box? Text box? Is it perhaps not a box at all? -->, select **Disabled**, and then select **OK**.
...
10. In the **Startup type** box<!-- Same box comment. -->, select **Disabled**, and then select **OK**.
...
13. In the **Startup type** box<!-- Same box comment. -->, select **Disabled**, and then select **OK**.
...
16. In the **Startup type** box<!-- Same box comment. -->, select **Disabled**, and then select **OK**.
...
2. In the **System Preparation tool 3.14** dialog box, in the **System Cleanup Action** box<!-- Same box comment. -->, select **Enter System Out-of-Box Experience (OOBE)**.
3. Select the **Generalize** check box.
4. In the **Shutdown Options** box<!-- Same box comment. -->, select **Shutdown**, and then select **OK**.
